...
execute if score @p BF_Mode matches 1 run data merge block -2026 78 750 {Text1:'{"text":"IRON ORES","color":"dark_gray","bold":true}',Text2:'["",{"text":"Hematite: ","color":"dark_gray"},{"score":{"name":"@p","objective":"BF_Hematite"},"color":"gold"}]',Text3:'["",{"text":"Malachite: ","color":"dark_gray"},{"score":{"name":"@p","objective":"BF_Malachite"},"color":"gold"}]',Text4:'["",{"text":"Cassiterite: ","color":"dark_gray"},{"score":{"name":"@p","objective":"BF_Cassiterite"},"color":"gold"}]'}
execute if score @p BF_Mode matches 1 run data merge block -2026 77 750 {Text1:'{"text":"GOLD ORES","color":"dark_gray","bold":true}',Text2:'["",{"text":"N. Gold: ","color":"dark_gray"},{"score":{"name":"@p","objective":"BF_Native_Gold"},"color":"gold"}]',Text3:'["",{"text":"N. Silver: ","color":"dark_gray"},{"score":{"name":"@p","objective":"BF_Native_Silver"},"color":"gold"}]',Text4:'["",{"text":"N. Platinum: ","color":"dark_gray"},{"score":{"name":"@p","objective":"BF_Native_Plat"},"color":"gold"}]'}
