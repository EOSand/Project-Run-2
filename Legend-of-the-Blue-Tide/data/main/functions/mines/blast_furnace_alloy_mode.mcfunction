...
# Steel 			Hematite / Iron			Coke
# Bronze 			Malachite / Copper		Cassiterite / Tin
# Platinum Aurum	N. Platinum / Platinum 	N. Gold / Gold
# Electrum 			N. Silver / Silver 		N. Gold / Gold

# Count how many ore in PRIMARY hopper
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Hematite","italic":false}'}}}]} run scoreboard players add @p BF_Iron 1
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Hematite","italic":false}'}}}]} run data merge block -2027 76 750 {Items:[]}
...
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Malachite","italic":false}'}}}]} run scoreboard players add @p BF_Copper 1
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Malachite","italic":false}'}}}]} run data merge block -2027 76 750 {Items:[]}

execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:iron_ingot",Count:1b,tag:{display:{Name:'{"text":"Copper Ingot","italic":false}'}}}]} run scoreboard players add @p BF_Copper 1
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:iron_ingot",Count:1b,tag:{display:{Name:'{"text":"Copper Ingot","italic":false}'}}}]} run data merge block -2027 76 750 {Items:[]}

execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Platinum","italic":false}'}}}]} run scoreboard players add @p BF_Platinum 1
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Platinum","italic":false}'}}}]} run data merge block -2027 76 750 {Items:[]}
...
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Silver","italic":false}'}}}]} run scoreboard players add @p BF_Silver 1
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Silver","italic":false}'}}}]} run data merge block -2027 76 750 {Items:[]}
...
execute if block -2027 76 744 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Cassiterite","italic":false}'}}}]} run scoreboard players add @p BF_Tin 1
execute if block -2027 76 744 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Cassiterite","italic":false}'}}}]} run data merge block -2027 76 744 {Items:[]}
...
execute if block -2027 76 744 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Gold","italic":false}'}}}]} run scoreboard players add @p BF_Gold 1
execute if block -2027 76 744 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Gold","italic":false}'}}}]} run data merge block -2027 76 744 {Items:[]}
