...
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Hematite","italic":false}'}}}]} run scoreboard players add @p BF_Hematite 1
...
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Cassiterite","italic":false}'}}}]} run scoreboard players add @p BF_Cassiterite 1
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Cassiterite","italic":false}'}}}]} run data merge block -2027 76 750 {Items:[]}

execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Malachite","italic":false}'}}}]} run scoreboard players add @p BF_Malachite 1
...
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Gold","italic":false}'}}}]} run scoreboard players add @p BF_Native_Gold 1
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Gold","italic":false}'}}}]} run data merge block -2027 76 750 {Items:[]}

execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Silver","italic":false}'}}}]} run scoreboard players add @p BF_Native_Silver 1
...
execute if block -2027 76 750 minecraft:hopper{Items:[{id:"minecraft:brick",Count:1b,tag:{display:{Name:'{"text":"Native Platinum","italic":false}'}}}]} run scoreboard players add @p BF_Native_Plat 1
...
execute if score @p BF_Malachite matches 1 if block -2026 76 750 minecraft:hopper{Items:[]} run data merge block -2028 76 747 {Items:[{id:"minecraft:iron_ingot",Count:1b,tag:{display:{Name:'{"text":"Copper Ingot","italic":false}'}}}]}
...
execute if score @p BF_Malachite matches 2.. run data merge block -2028 76 747 {Items:[{id:"minecraft:iron_ingot",Count:1b,tag:{display:{Name:'{"text":"Copper Ingot","italic":false}'}}}]}
