...
execute if score @p Timer matches 0 run tellraw @p ["",{"text":"[Dr. Anvar]","color":"aqua"},{"text":" Welcome back, ","color":"aqua","extra":[{"selector":"@p"},{"text":". Dr. Bright just sent us a message that you will be headed to the site of the failed mission, are you not?"}]}]
...
execute if score @p Timer matches 460 run tellraw @p ["",{"text":"[Dr. Percival]","color":"aqua"},{"text":" Also, if you need to run back into the city to grab something, be it food, armor, weapons, etc., please feel free to return at any time. Just know that once you step foot in the pod, there's no going back.","color":"aqua"}]
...
execute if score @p Timer matches 560 run execute as @p run say Okay, thanks for letting me know and will do.
