...
# Dialogue
tellraw @p ["",{"text":"[Dr. Anvar]","color":"aqua"},{"text":" Ah, it is you. Please use the main exit behind you and head to the top floor, someone is awaiting your presence.","color":"aqua"}]
