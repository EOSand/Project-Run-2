...
execute if score @p Timer matches 801 run data merge block -1916 56 794 {auto:0}

# Replace comparator
execute if score @p Timer matches 801 run setblock -1918 56 794 minecraft:comparator[facing=west]
